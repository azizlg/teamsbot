...
public sealed class GraphCallsService
{
        ...
        CancellationToken ct = default)
    {
        ...
        var body = new JsonObject
        {
            ...
            // If mediaBlob is empty, fall back to serviceHostedMediaConfig (no audio).
            ["mediaConfig"] = string.IsNullOrEmpty(mediaBlob)
                ? new JsonObject
                {
        ...
        _logger.LogInformation("Joining meeting {MeetingId} (tenant={Tenant}), mediaConfig={ConfigType}, blobLen={BlobLen}",
            meetingId, tenantId[..8] + "...",
            string.IsNullOrEmpty(mediaBlob) ? "serviceHosted" : "appHosted",
            mediaBlob?.Length ?? 0);
